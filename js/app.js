...
function onReady() {
    ...
    exitButton.addEventListener('click', function(){
        if (window.confirm('Are you sure you want to leave? I worked really hard on this!')) {}
    ...
    //helpful for challenge- where it asks you to confirm// much more attractive box can be created using jquerry
    // window is always there and tell us abt current url and get us to any other url
} //onReady()
...
function onSubmit(eventObject) {
    ...
    console.log(dob);
    //get value of any of the things
    //this refers to element that raises the element
...
function displayMessage(message, isError) {
    ...
    msgElem.className = isError ? 'alert alert-anger' : 'alert alert-success';
    msgElem.style.display = 'block';
} //displayMessage()
//java script library
//moment js- formating of date